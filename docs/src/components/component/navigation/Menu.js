...
function Menu() {
  return (
    <React.Fragment>
      <Heading heading="Menu" id="menu" />
      <Paragraph paragraph="The menu is a vertical list of navigational links. A menu's width and placement must be set by you. If you like, just use our grid columns as a parent. Otherwise, apply a custom width." />
      <CodeBlocks
        htmlcoderender={[
          <div>
            <nav className="menu" aria-label="Person settings">
              <a className="menu-item" href="#url" aria-current="page">
                Account
              </a>
        ...
        lang="html"
      />
      <Paragraph paragraph="There are a few subcomponents and add-ons that work well with the menu, including avatars, counters, and Octicons." />
      <CodeBlocks
        htmlcoderender={[
          <div>
            <nav className="menu" aria-label="Person settings">
      ...
      <Paragraph paragraph="You can also add optional headings to a menu. Feel free to use nearly any semantic element with the .menu-heading class, including inline elements, headings, and more." />
      <CodeBlocks
        htmlcoderender={[
          <div>
