...
function ToastWithDismiss() {
  return (
    <React.Fragment>
      <Heading heading="Toast with dismiss" id="toast-with-dismiss" />
      <Paragraph paragraph="Use .Toast-dismissButton to allow a user to explicitly dismiss a Toast." />
      <CodeBlocks
        htmlcoderender={[
          <div className="p-1">
            <div className="Toast">
