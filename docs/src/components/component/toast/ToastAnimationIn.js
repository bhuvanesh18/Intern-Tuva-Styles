...
function ToastAnimationIn() {
  return (
    <React.Fragment>
      <Heading heading="Toast animation in" id="toast-animation-in" />
      <Paragraph paragraph="The Toast--animateIn and Toast--animateOut modifier classes can be used to animate the toast in and out from the bottom." />
      <CodeBlocks
        htmlcoderender={[
          <div className="p-1">
...
export default ToastAnimationIn;
